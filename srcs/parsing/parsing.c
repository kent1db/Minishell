...
/*   Updated: 2021/06/08 12:51:35 by qurobert         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

int		ft_start(char *line, int start, int i, t_tree *node)
{
	int	beg;
...
t_tree	*ft_binary_tree(char *line, int start, int end, t_all *a)
{
	...
	ft_priority(line, ft_start(line, &start, a->tree->loop, node), end, node);
